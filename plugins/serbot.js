...
let rtx2 = "𝗛𝗼𝗹𝗮 𝗽𝗮𝗽𝗶, 𝗬𝗮 𝘁𝗲 𝗺𝗮𝗻𝗱𝗼 𝗰𝗼𝗱𝗶𝗴𝗼 𝗼 𝘀𝗶 𝗱𝗮𝗱𝗱𝘆.";
...
async function joinChannels(conn) {
  await conn.newsletterFollow("120363422161687949@newsletter")
  conn.newsletterFollow("120363422161687949@newsletter")
}